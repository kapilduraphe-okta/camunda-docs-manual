...
# Environment Setup and the License Key
...
This method can be used in any scenario, i.e. environment setup. The license key can be set via the 
Java API by calling:
...
This is another method that can be applied in any scenario, i.e. environment setup. The license key will be 
automatically loaded in the database table unless a license key is already present.

## With the Camunda Spring Boot Starter & Camunda Run

Camunda Run, and other Spring Boot applications that use the Camunda Spring Boot Starter, can provide license 
keys in two additional ways:
